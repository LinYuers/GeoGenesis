...
const config = {
  ...
  url: 'https://Linyuers.github.io', // Your website URL
  // Set the /<baseUrl>/ pathname under which your site is served
  // For GitHub pages deployment, it is often '/<projectName>/'
  baseUrl: '/GeoGenesis/', // Base URL for your project */

  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: 'LinYuers', // Usually your GitHub org/user name.
  projectName: 'GeoGenesis', // Usually your repo name.
